...
class ZamanDetails extends StatefulWidget {
  @override
  _ZamanDetailsState createState() => _ZamanDetailsState();
}

class _ZamanDetailsState extends State<ZamanDetails> {
  var isInit = true;
  var isLoading = false;
  var checked = false;
  ...
  Future deleteStage (orderId , orderData) async {
    await Future.delayed(const Duration(seconds: 0));
    orderData.deleteZamanOrders(orderId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color(0xffD5BE9F),
                                       ...
                                       Consumer<Orders>(
                                         builder:(context , orderData , _) => FlatButton(
                                           ...
                                           onPressed: () async {
                                             ...
                                             Navigator.of(context).pushReplacementNamed('ZamanOrdersScreen');
                                           },
                                         ),
                                       ),
                                       SizedBox(
